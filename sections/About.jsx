...
const About = () => (
  ...
  Kopite Madness    </span>
   ...
   <span className='font-extrabold text-black'> Madness of the Kopites  </span>
   of today, using only 
   <span className='font-extrabold text-black'> VR </span>
   devices you can easily 
   <span className='font-extrabold text-black'> explore </span>
